...
@section('content')
    ...
    <div class="container-fluid" style="margin-left:100px;padding-top:10px" >
            <img class="col-md-6" src="{{$shop->shop_pict}}" alt="FCC"  height="400px" >
                <div class="col-md-1" style="margin-right:85px">
                    <img src="{{$shop->shop_pict1}}" alt="FCC1" height="200" width="200" style="padding-bottom: 5px">
                    
                    <img  src="{{$shop->shop_pict2}}" alt="FCC2" height="200" width="200" style="padding-top: 5px">
                    
                </div>                        
                <div class="col-md-3" style="margin-right:100px">
                    <img src="{{$shop->shop_pict3}}" alt="FCC3" height="200" width="200" style="padding-bottom: 5px">
                    <img src="{{$shop->shop_pict4}}" alt="FCC3" height="200" width="200" style="padding-top: 5px">
                </div>
    </div>
    ...
    <div class="container-fluid" style="margin-left:100px;padding-top: 40px">
        <div class="col-md-6">
            <h2> Menu </h2>
            <img src="{{$shop->menu_pict}}" alt="menu" height="400" width="355">
            <img src="{{$shop->menu_pict1}}" alt="drink" height="400" width="355" style="padding-left: 30px">
    ...
    <div class="col-md-12" style="padding-top:40px;">
        ...
        <br>
        <input type="submit" class="wpcf7-form-control wpcf7-submit" value="Submit" style="font-size: 15px">
        </form>
    </div>
